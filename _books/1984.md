...
olid: OL24382006M # use Open Library ID to fetch cover (if no `cover` is provided)
isbn: 0451524934 # use ISBN to fetch cover (if no `olid` is provided, dashes are optional)
